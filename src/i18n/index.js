...
const tr = {
  ...
  ai: {
    ...
    no_key_body: 'Yapay zeka özelliğini kullanmak için Anthropic API anahtarınızı Ayarlar sayfasına girin.',
  ...
  settings: {
    ...
    language_tr: 'Türkçe',
    language_de: 'Deutsch',
    api_key_label: 'Anthropic API Anahtarı',
...
const de = {
  ...
  ai: {
    ...
    no_key_body: 'Gib deinen Anthropic API-Schlüssel in den Einstellungen ein, um die KI-Funktion zu nutzen.',
  ...
  settings: {
    ...
    language_tr: 'Türkçe',
    language_de: 'Deutsch',
    api_key_label: 'Anthropic API-Schlüssel',
    api_key_placeholder: 'sk-ant-...',
